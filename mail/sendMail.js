...
module.exports = function (mailFrom, mailTo, title, body, attachments, callpack) {
    ...
    transporter.sendMail(mailOptions, function (err, info) {
        ...
        if (typeof callpack === "function") {
            callpack(mailMsg, mailOptions.subject, mailOptions.html, mailOptions.from, mailOptions.to);
        }
