...
router.get('/', function (req, res) {
    ...
    var title = 'member-api running now.';
    logger.info(title);
    ...
    models.Member
        ...
        .spread(function (data, created) {
            ...
            if (created) {
                ...
                _callposg.create(data, function (cb_data) {
                    //res.json(data)
                    console.log(cb_data)
                })

                setTimeout(function () {
                    _callposg.getmember(mobilphone, function () { })
                }, 1000);
        ...
        where: {
            ...
            if (data != null) {
                ...
                if (srctime > localtime) {
                    ...
                    _callposg.update(data, function (cb_data) {
