...
//文件 https://cn27529.gitbooks.io/alan-app/content/account.html
        ...
        if (
          ...
          var mail_data = {
            ...
            body:
              'Dear ' +
              name +
              ',<br>Thank you for contacting us<br>This is your password: <br>For your account security, please change your passowrd later.',
            pwd: _pw.decode(pwd),
            attachments: []
            // attachments: [{
